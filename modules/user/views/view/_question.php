...
<div class="question-summary">
    <div class="row">
        <div class="col-xs-3">
            <div class="row">
                <div class="favorites-count col-xs-3">
                ...
                <div class="votes col-xs-3">
                    <div class="mini-counts"><?php echo $fav->question->score;?></div>
                    <div>票</div>
                </div>
                <div class="col-xs-3 status<?php if ($fav->question->accepted) echo " answered-accepted"; else echo " answered";?>">
                    <div class="mini-counts"><?php echo $fav->question->answercount;?></div>
                    <div>答案</div>
                </div>
                <div class="views col-xs-3">
        ...
        <div id="question-summary-<?php echo $fav->question->id;?>" class="col-xs-9">

            <div class="summary">
                <h3>
                    <?= Html::a(Html::encode($fav->question->title), $fav->question->url,['class'=>'question-hyperlink','title'=>Html::encode($fav->question->title)]);?>
                </h3>
