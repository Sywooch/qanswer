<div id="mainbar-full">
    <div class="subheader">
        ...
        $menu = array(
            'items' => array(
                array('label' => '基本信息', 'url' => array('/user/view/index', 'id' => $user->id, 'tab' => 'stats'), 'options' => array('title' => '基本信息和统计')),
                array('label' => '活动', 'url' => array('/user/view/index', 'id' => $user->id, 'tab' => 'activity'), 'options' => array('title' => '最近活动')),
                array('label' => '威望', 'url' => array('/user/view/index', 'id' => $user->id, 'tab' => 'reputation'), 'options' => array('title' => '威望历史记录')),
                array('label' => '收藏', 'url' => array('/user/view/index', 'id' => $user->id, 'tab' => 'favorites'), 'options' => array('title' => '收藏的问题')),
            ),
