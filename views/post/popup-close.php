<div id="close-question-popup" class="popup" style="width:690px;">
    <div class="popup-close"><a title="关闭 (或单击Esc)">&times;</a></div>
    ...
    <div style="overflow:hidden">
        <form id="close-question-form" action="<?php echo Yii::$app->urlManager->createUrl(['post/vote', 'postid'=>$question->id, 'type'=>6]);?>">
